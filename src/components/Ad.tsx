    ...
    return (
        <div className='p-4 bg-white rounded-lg shadow-md text-sm'>
            ...
            >
                ...
                >
                    <Image
                        src="https://images.pexels.com/photos/28584803/pexels-photo-28584803.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
                        alt=""
                        fill
                ...
                <p className={size==="sm" ? "text-xs" : "text-sm"}>
                    {size === "sm" 
                        ...
                        : size==="md" 
                        ? "Lorem ipsum sit amet consectetur adipisicing elit. Lorem ipsum sit amet consectetur adipisicing elit." 
