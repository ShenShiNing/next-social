  ...
  return (
    <div className=''>
      ...
      {open && <div className="absolute w-screen h-screen top-0 left-0 bg-black bg-opacity-65 flex items-center justify-center z-50">
        <form 
          action={
            (formData)=>formAction({formData: formData, cover: cover?.secure_url || ""})
          } 
        ...
        >
              ...
              return (
                <div className="flex flex-col gap-4 my-4" onClick={() => open()}>
                  ...
                  <div className="flex items-center gap-2 cursor-pointer">
                    ...
                    <span className="text-xs underline text-gray-6 00">Change</span>
                  </div>
                </div>
              )
            }}
          ...
          {state.success && <span className="text-green-500">Profiles has been updated!</span>}
          {state.error && <span className="text-red-500">Something went wrong!</span>}
          <div className="absolute text-lg right-5 top-3 cursor-pointer" onClick={handleClose}>X</div>
        </form>
