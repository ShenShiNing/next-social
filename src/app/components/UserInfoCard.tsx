    ...
    return (
        <div className='p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-4'>
            ...
            <div className="flex flex-col gap-4 text-gray-500">
                ...
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus exercitationem quis
                </p>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex gap-1 items-center">
                        ...
                        <Link href="http://lama.dev" className="text-blue-500 font-medium">
                            lama.dev
                        </Link>
                    </div>
                    <div className="flex gap-1 items-center">
                ...
                <button className="text-red-400 self-end text-xs cursor-pointer">Block User</button>
            </div>
        </div>
    )
}
